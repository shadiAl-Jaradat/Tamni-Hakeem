...
class DiabetesStatisticsPage extends StatefulWidget {
  const DiabetesStatisticsPage({super.key});
  @override
  State<DiabetesStatisticsPage> createState() =>
      _DiabetesStatisticsPageStatisticsPageState();
}

class _DiabetesStatisticsPageStatisticsPageState
    extends State<DiabetesStatisticsPage> {
  List<String> years = [
    "٢٠١٦",
    "٢٠١٧",
    "٢٠١٨",
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            Row(
              ...
              children: [
                _buildStatisticsCard(
                    color: Color(0xff755308),
                    current: 150,
                    goal: 250,
                    title: "الذكور"),
                _buildStatisticsCard(
                    color: Color(0xffC28C17),
                    current: 100,
                    goal: 250,
                    title: "الاناث"),
              ],
